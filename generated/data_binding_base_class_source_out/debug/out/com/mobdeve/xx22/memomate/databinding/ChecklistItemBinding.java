...
public final class ChecklistItemBinding implements ViewBinding {
  ...
  private ChecklistItemBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox checkBox,
  ...
  public static ChecklistItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChecklistItemBinding((ConstraintLayout) rootView, checkBox, editText);
    }
